...
namespace AI21
{
    public partial class LibraryManagementClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AI21.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AI21.AutoSDKHttpResponse<string>> V1LibraryUploadAsResponseAsync(
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (request.UploadMode != default)
                            {
                                ...
                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent((request.UploadMode).HasValue ? (request.UploadMode).GetValueOrDefault().ToValueString() : string.Empty),
                                    name: "\"upload_mode\"");
                            ...
                            if (request.BatchId != default)
                            {
                                ...
                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(request.BatchId.ToString() ?? string.Empty),
                                    name: "\"batch_id\"");
                            ...
                            if (request.DataSource != default)
                            {
                                ...
                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(request.DataSource ?? string.Empty),
                                    name: "\"data_source\"");
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::AI21.BodyV1LibraryUpload
            {
