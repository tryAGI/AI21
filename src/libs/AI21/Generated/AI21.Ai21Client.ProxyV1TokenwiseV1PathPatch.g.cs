...
namespace AI21
{
    public partial class Ai21Client
    {
        ...
        private static readonly global::AI21.EndPointSecurityRequirement s_ProxyV1TokenwiseV1PathPatchSecurityRequirement0 =
        ...
        private static readonly global::AI21.EndPointSecurityRequirement[] s_ProxyV1TokenwiseV1PathPatchSecurityRequirements =
            new global::AI21.EndPointSecurityRequirement[]
            {                s_ProxyV1TokenwiseV1PathPatchSecurityRequirement0,
            };
        partial void PrepareProxyV1TokenwiseV1PathPatchArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string path,
            ref string? xAi21Key);
        partial void PrepareProxyV1TokenwiseV1PathPatchRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string path,
            string? xAi21Key);
        partial void ProcessProxyV1TokenwiseV1PathPatchResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessProxyV1TokenwiseV1PathPatchResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> ProxyV1TokenwiseV1PathPatchAsync(
            string path,
            string? xAi21Key = default,
            global::AI21.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ProxyV1TokenwiseV1PathPatchAsResponseAsync(
                path: path,
                xAi21Key: xAi21Key,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AI21.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AI21.AutoSDKHttpResponse<string>> ProxyV1TokenwiseV1PathPatchAsResponseAsync(
            string path,
            string? xAi21Key = default,
            global::AI21.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareProxyV1TokenwiseV1PathPatchArguments(
            ...
            var __authorizations = global::AI21.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ProxyV1TokenwiseV1PathPatchSecurityRequirements,
                operationName: "ProxyV1TokenwiseV1PathPatchAsync");
            ...
            if (xAi21Key != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareProxyV1TokenwiseV1PathPatchRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AI21.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AI21.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ProxyV1TokenwiseV1PathPatch",
                                methodName: "ProxyV1TokenwiseV1PathPatchAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessProxyV1TokenwiseV1PathPatchResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AI21.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessProxyV1TokenwiseV1PathPatchResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
