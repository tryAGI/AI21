...
namespace AI21
{
    public partial class Ai21Client
    {
        ...
        private static readonly global::AI21.EndPointSecurityRequirement s_VidaaMessagesSolutionsVidaaApiMessagesPostSecurityRequirement0 =
        ...
        private static readonly global::AI21.EndPointSecurityRequirement[] s_VidaaMessagesSolutionsVidaaApiMessagesPostSecurityRequirements =
            new global::AI21.EndPointSecurityRequirement[]
            {                s_VidaaMessagesSolutionsVidaaApiMessagesPostSecurityRequirement0,
            };
        partial void PrepareVidaaMessagesSolutionsVidaaApiMessagesPostArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareVidaaMessagesSolutionsVidaaApiMessagesPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessVidaaMessagesSolutionsVidaaApiMessagesPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessVidaaMessagesSolutionsVidaaApiMessagesPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> VidaaMessagesSolutionsVidaaApiMessagesPostAsync(
            global::AI21.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareVidaaMessagesSolutionsVidaaApiMessagesPostArguments(
                httpClient: HttpClient);


            var __authorizations = global::AI21.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_VidaaMessagesSolutionsVidaaApiMessagesPostSecurityRequirements,
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            var __pathBuilder = new global::AI21.PathBuilder(
                                path: "/solutions/vidaa/api/messages",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareVidaaMessagesSolutionsVidaaApiMessagesPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AI21.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AI21.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "VidaaMessagesSolutionsVidaaApiMessagesPost",
                                methodName: "VidaaMessagesSolutionsVidaaApiMessagesPostAsync",
                                pathTemplate: "\"/solutions/vidaa/api/messages\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessVidaaMessagesSolutionsVidaaApiMessagesPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AI21.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessVidaaMessagesSolutionsVidaaApiMessagesPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
