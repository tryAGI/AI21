...
namespace AI21
{
    public partial class Ai21Client
    {
        ...
        private static readonly global::AI21.EndPointSecurityRequirement s_KirshEmailAssistantSolutionsKirshEmailAssistantPostSecurityRequirement0 =
        ...
        private static readonly global::AI21.EndPointSecurityRequirement[] s_KirshEmailAssistantSolutionsKirshEmailAssistantPostSecurityRequirements =
            new global::AI21.EndPointSecurityRequirement[]
            {                s_KirshEmailAssistantSolutionsKirshEmailAssistantPostSecurityRequirement0,
            };
        partial void PrepareKirshEmailAssistantSolutionsKirshEmailAssistantPostArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareKirshEmailAssistantSolutionsKirshEmailAssistantPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessKirshEmailAssistantSolutionsKirshEmailAssistantPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessKirshEmailAssistantSolutionsKirshEmailAssistantPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> KirshEmailAssistantSolutionsKirshEmailAssistantPostAsync(
            global::AI21.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareKirshEmailAssistantSolutionsKirshEmailAssistantPostArguments(
                httpClient: HttpClient);


            var __authorizations = global::AI21.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_KirshEmailAssistantSolutionsKirshEmailAssistantPostSecurityRequirements,
                operationName: "KirshEmailAssistantSolutionsKirshEmailAssistantPostAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            var __pathBuilder = new global::AI21.PathBuilder(
                                path: "/solutions/kirsh/email-assistant",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareKirshEmailAssistantSolutionsKirshEmailAssistantPostRequest(
                    httpClient: HttpClient,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AI21.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AI21.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "KirshEmailAssistantSolutionsKirshEmailAssistantPost",
                                methodName: "KirshEmailAssistantSolutionsKirshEmailAssistantPostAsync",
                                pathTemplate: "\"/solutions/kirsh/email-assistant\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::AI21.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessKirshEmailAssistantSolutionsKirshEmailAssistantPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
