...
namespace AI21
{
    public partial class Ai21Client
    {
        ...
        private static readonly global::AI21.EndPointSecurityRequirement s_AnalyticsContextBlocksGatewayAnalyticsV1ContextBlocksGetSecurityRequirement0 =
        ...
        private static readonly global::AI21.EndPointSecurityRequirement[] s_AnalyticsContextBlocksGatewayAnalyticsV1ContextBlocksGetSecurityRequirements =
            new global::AI21.EndPointSecurityRequirement[]
            {                s_AnalyticsContextBlocksGatewayAnalyticsV1ContextBlocksGetSecurityRequirement0,
            };
        partial void PrepareAnalyticsContextBlocksGatewayAnalyticsV1ContextBlocksGetArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareAnalyticsContextBlocksGatewayAnalyticsV1ContextBlocksGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessAnalyticsContextBlocksGatewayAnalyticsV1ContextBlocksGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAnalyticsContextBlocksGatewayAnalyticsV1ContextBlocksGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> AnalyticsContextBlocksGatewayAnalyticsV1ContextBlocksGetAsync(
            global::AI21.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await AnalyticsContextBlocksGatewayAnalyticsV1ContextBlocksGetAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AI21.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AI21.AutoSDKHttpResponse<string>> AnalyticsContextBlocksGatewayAnalyticsV1ContextBlocksGetAsResponseAsync(
            global::AI21.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAnalyticsContextBlocksGatewayAnalyticsV1ContextBlocksGetArguments(
                httpClient: HttpClient);


            var __authorizations = global::AI21.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_AnalyticsContextBlocksGatewayAnalyticsV1ContextBlocksGetSecurityRequirements,
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::AI21.PathBuilder(
                                path: "/gateway/analytics/v1/context/blocks",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAnalyticsContextBlocksGatewayAnalyticsV1ContextBlocksGetRequest(
                    httpClient: HttpClient,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AI21.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AI21.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AnalyticsContextBlocksGatewayAnalyticsV1ContextBlocksGet",
                                methodName: "AnalyticsContextBlocksGatewayAnalyticsV1ContextBlocksGetAsync",
                                pathTemplate: "\"/gateway/analytics/v1/context/blocks\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::AI21.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAnalyticsContextBlocksGatewayAnalyticsV1ContextBlocksGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
