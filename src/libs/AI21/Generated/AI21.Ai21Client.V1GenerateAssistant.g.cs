...
namespace AI21
{
    public partial class Ai21Client
    {
        ...
        private static readonly global::AI21.EndPointSecurityRequirement s_V1GenerateAssistantSecurityRequirement0 =
        ...
        private static readonly global::AI21.EndPointSecurityRequirement[] s_V1GenerateAssistantSecurityRequirements =
            new global::AI21.EndPointSecurityRequirement[]
            {                s_V1GenerateAssistantSecurityRequirement0,
            };
        partial void PrepareV1GenerateAssistantArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::AI21.GenerateAssistantRequest request);
        partial void PrepareV1GenerateAssistantRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::AI21.GenerateAssistantRequest request);
        partial void ProcessV1GenerateAssistantResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessV1GenerateAssistantResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::AI21.GenerateAssistantResponse> V1GenerateAssistantAsync(

            global::AI21.GenerateAssistantRequest request,
            global::AI21.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await V1GenerateAssistantAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AI21.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AI21.AutoSDKHttpResponse<global::AI21.GenerateAssistantResponse>> V1GenerateAssistantAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareV1GenerateAssistantArguments(
            ...
            var __authorizations = global::AI21.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1GenerateAssistantSecurityRequirements,
                operationName: "V1GenerateAssistantAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::AI21.PathBuilder(
                                path: "/studio/v1/assistants/generate",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareV1GenerateAssistantRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AI21.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AI21.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1GenerateAssistant",
                                methodName: "V1GenerateAssistantAsync",
                                pathTemplate: "\"/studio/v1/assistants/generate\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1GenerateAssistantResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AI21.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessV1GenerateAssistantResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::AI21.GenerateAssistantResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::AI21.AutoSDKHttpResponse<global::AI21.GenerateAssistantResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::AI21.GenerateAssistantResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::AI21.GenerateAssistantResponse> V1GenerateAssistantAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::AI21.GenerateAssistantRequest
            {
                Prompt = prompt,
                Avatar = avatar,
            };
