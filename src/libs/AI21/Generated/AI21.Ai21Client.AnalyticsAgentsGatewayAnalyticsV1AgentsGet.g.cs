...
namespace AI21
{
    public partial class Ai21Client
    {
        ...
        private static readonly global::AI21.EndPointSecurityRequirement s_AnalyticsAgentsGatewayAnalyticsV1AgentsGetSecurityRequirement0 =
        ...
        private static readonly global::AI21.EndPointSecurityRequirement[] s_AnalyticsAgentsGatewayAnalyticsV1AgentsGetSecurityRequirements =
            new global::AI21.EndPointSecurityRequirement[]
            {                s_AnalyticsAgentsGatewayAnalyticsV1AgentsGetSecurityRequirement0,
            };
        partial void PrepareAnalyticsAgentsGatewayAnalyticsV1AgentsGetArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareAnalyticsAgentsGatewayAnalyticsV1AgentsGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessAnalyticsAgentsGatewayAnalyticsV1AgentsGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAnalyticsAgentsGatewayAnalyticsV1AgentsGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> AnalyticsAgentsGatewayAnalyticsV1AgentsGetAsync(
            global::AI21.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await AnalyticsAgentsGatewayAnalyticsV1AgentsGetAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AI21.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AI21.AutoSDKHttpResponse<string>> AnalyticsAgentsGatewayAnalyticsV1AgentsGetAsResponseAsync(
            global::AI21.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAnalyticsAgentsGatewayAnalyticsV1AgentsGetArguments(
                httpClient: HttpClient);


            var __authorizations = global::AI21.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_AnalyticsAgentsGatewayAnalyticsV1AgentsGetSecurityRequirements,
                operationName: "AnalyticsAgentsGatewayAnalyticsV1AgentsGetAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::AI21.PathBuilder(
                                path: "/gateway/analytics/v1/agents",
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AI21.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AI21.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AnalyticsAgentsGatewayAnalyticsV1AgentsGet",
                                methodName: "AnalyticsAgentsGatewayAnalyticsV1AgentsGetAsync",
                                pathTemplate: "\"/gateway/analytics/v1/agents\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::AI21.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAnalyticsAgentsGatewayAnalyticsV1AgentsGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
