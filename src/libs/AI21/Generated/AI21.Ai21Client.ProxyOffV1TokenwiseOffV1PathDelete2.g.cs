...
namespace AI21
{
    public partial class Ai21Client
    {
        ...
        private static readonly global::AI21.EndPointSecurityRequirement s_ProxyOffV1TokenwiseOffV1PathDelete2SecurityRequirement0 =
        ...
        private static readonly global::AI21.EndPointSecurityRequirement[] s_ProxyOffV1TokenwiseOffV1PathDelete2SecurityRequirements =
            new global::AI21.EndPointSecurityRequirement[]
            {                s_ProxyOffV1TokenwiseOffV1PathDelete2SecurityRequirement0,
            };
        partial void PrepareProxyOffV1TokenwiseOffV1PathDelete2Arguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string path,
            ref string? xAi21Key);
        partial void PrepareProxyOffV1TokenwiseOffV1PathDelete2Request(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string path,
            string? xAi21Key);
        partial void ProcessProxyOffV1TokenwiseOffV1PathDelete2Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessProxyOffV1TokenwiseOffV1PathDelete2ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> ProxyOffV1TokenwiseOffV1PathDelete2Async(
            string path,
            string? xAi21Key = default,
            global::AI21.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ProxyOffV1TokenwiseOffV1PathDelete2AsResponseAsync(
                path: path,
                xAi21Key: xAi21Key,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AI21.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AI21.AutoSDKHttpResponse<string>> ProxyOffV1TokenwiseOffV1PathDelete2AsResponseAsync(
            string path,
            string? xAi21Key = default,
            global::AI21.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareProxyOffV1TokenwiseOffV1PathDelete2Arguments(
            ...
            var __authorizations = global::AI21.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ProxyOffV1TokenwiseOffV1PathDelete2SecurityRequirements,
                operationName: "ProxyOffV1TokenwiseOffV1PathDelete2Async");
            ...
            if (xAi21Key != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareProxyOffV1TokenwiseOffV1PathDelete2Request(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AI21.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AI21.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ProxyOffV1TokenwiseOffV1PathDelete2",
                                methodName: "ProxyOffV1TokenwiseOffV1PathDelete2Async",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessProxyOffV1TokenwiseOffV1PathDelete2Response(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AI21.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessProxyOffV1TokenwiseOffV1PathDelete2ResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
