...
namespace AI21
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::AI21.AutoSDKRetryOptions Retry { get; set; } = new global::AI21.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::AI21.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::AI21.IAutoSDKHook>();
        ...
        public global::AI21.AutoSDKClientOptions AddHook(
            global::AI21.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::AI21.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::AI21.AutoSDKClientOptions UseAuthorizationProvider(
            global::AI21.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::AI21.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::AI21.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::AI21.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::AI21.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::AI21.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::AI21.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::AI21.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::AI21.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::AI21.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::AI21.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::AI21.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::AI21.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::AI21.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::AI21.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::AI21.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    internal static class AutoSDKRequestOptionsSupport
    {
        internal static global::AI21.AutoSDKHookContext CreateHookContext(
            ...
            global::AI21.AutoSDKClientOptions clientOptions,
            global::AI21.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::AI21.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::AI21.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::AI21.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::AI21.AutoSDKClientOptions clientOptions,
            global::System.Func<global::AI21.IAutoSDKHook, global::AI21.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::AI21.AutoSDKHookContext context)
        {
