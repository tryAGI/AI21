...
namespace AI21
{
    ...
    public sealed partial class FileSearchToolResource
    {
        ...
        /// Default Value: false
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("use_two_step_embedders")]
        public bool? UseTwoStepEmbedders { get; set; }
        ...
        /// Default Value: 1
        /// </param>
        /// <param name="useTwoStepEmbedders">
        /// Default Value: false
        /// </param>
            ...
            bool? useTwoStepEmbedders)
        {
            ...
            this.UseTwoStepEmbedders = useTwoStepEmbedders;
        }
