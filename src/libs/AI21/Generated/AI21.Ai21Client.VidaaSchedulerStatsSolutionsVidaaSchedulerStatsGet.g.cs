...
namespace AI21
{
    public partial class Ai21Client
    {
        ...
        private static readonly global::AI21.EndPointSecurityRequirement s_VidaaSchedulerStatsSolutionsVidaaSchedulerStatsGetSecurityRequirement0 =
        ...
        private static readonly global::AI21.EndPointSecurityRequirement[] s_VidaaSchedulerStatsSolutionsVidaaSchedulerStatsGetSecurityRequirements =
            new global::AI21.EndPointSecurityRequirement[]
            {                s_VidaaSchedulerStatsSolutionsVidaaSchedulerStatsGetSecurityRequirement0,
            };
        partial void PrepareVidaaSchedulerStatsSolutionsVidaaSchedulerStatsGetArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareVidaaSchedulerStatsSolutionsVidaaSchedulerStatsGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessVidaaSchedulerStatsSolutionsVidaaSchedulerStatsGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessVidaaSchedulerStatsSolutionsVidaaSchedulerStatsGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Vidaa Scheduler Stats
        /// </summary>
        /// <param name="requestOptions">Per-request overrides such as headers, query parameters, timeout, retries, and response buffering.</param>
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AI21.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<string> VidaaSchedulerStatsSolutionsVidaaSchedulerStatsGetAsync(
            global::AI21.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareVidaaSchedulerStatsSolutionsVidaaSchedulerStatsGetArguments(
                httpClient: HttpClient);


            var __authorizations = global::AI21.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_VidaaSchedulerStatsSolutionsVidaaSchedulerStatsGetSecurityRequirements,
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            var __pathBuilder = new global::AI21.PathBuilder(
                                path: "/solutions/vidaa/scheduler-stats",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareVidaaSchedulerStatsSolutionsVidaaSchedulerStatsGetRequest(
                    httpClient: HttpClient,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AI21.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AI21.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "VidaaSchedulerStatsSolutionsVidaaSchedulerStatsGet",
                                methodName: "VidaaSchedulerStatsSolutionsVidaaSchedulerStatsGetAsync",
                                pathTemplate: "\"/solutions/vidaa/scheduler-stats\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::AI21.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessVidaaSchedulerStatsSolutionsVidaaSchedulerStatsGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
