...
namespace AI21
{
    public partial class Ai21Client
    {
        ...
        private static readonly global::AI21.EndPointSecurityRequirement s_V1ModifyRouteSecurityRequirement0 =
        ...
        private static readonly global::AI21.EndPointSecurityRequirement[] s_V1ModifyRouteSecurityRequirements =
            new global::AI21.EndPointSecurityRequirement[]
            {                s_V1ModifyRouteSecurityRequirement0,
            };
        ...
        partial void PrepareV1ModifyRouteRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string routeId,
            string assistantId,
            global::AI21.UpdateRoutePayload request);
        partial void ProcessV1ModifyRouteResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessV1ModifyRouteResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::AI21.AssistantRoute> V1ModifyRouteAsync(
            string routeId,
            string assistantId,
        ...
        {
            var __response = await V1ModifyRouteAsResponseAsync(
                routeId: routeId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AI21.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AI21.AutoSDKHttpResponse<global::AI21.AssistantRoute>> V1ModifyRouteAsResponseAsync(
            string routeId,
            string assistantId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::AI21.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1ModifyRouteSecurityRequirements,
                operationName: "V1ModifyRouteAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AI21.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AI21.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1ModifyRoute",
                                methodName: "V1ModifyRouteAsync",
                                pathTemplate: "$\"/studio/v1/assistants/{assistantId}/routes/{routeId}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::AI21.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessV1ModifyRouteResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::AI21.AssistantRoute.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::AI21.AutoSDKHttpResponse<global::AI21.AssistantRoute>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::AI21.AssistantRoute.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::AI21.AssistantRoute> V1ModifyRouteAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::AI21.UpdateRoutePayload
            {
                Description = description,
                Examples = examples,
            };

            return await V1ModifyRouteAsync(
                routeId: routeId,
                assistantId: assistantId,
                request: __request,
                requestOptions: requestOptions,
