...
namespace AI21
{
    public partial class SecretsClient
    {
        ...
        private static readonly global::AI21.EndPointSecurityRequirement s_V1SecretStorage4SecurityRequirement0 =
        ...
        private static readonly global::AI21.EndPointSecurityRequirement[] s_V1SecretStorage4SecurityRequirements =
            new global::AI21.EndPointSecurityRequirement[]
            {                s_V1SecretStorage4SecurityRequirement0,
            };
        partial void PrepareV1SecretStorage4Arguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string secretId,
            global::AI21.UpdateSecretPayload request);
        partial void PrepareV1SecretStorage4Request(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string secretId,
            global::AI21.UpdateSecretPayload request);
        partial void ProcessV1SecretStorage4Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessV1SecretStorage4ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> V1SecretStorage4Async(
            string secretId,
        ...
        {
            var __response = await V1SecretStorage4AsResponseAsync(
                secretId: secretId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AI21.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AI21.AutoSDKHttpResponse<string>> V1SecretStorage4AsResponseAsync(
            string secretId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareV1SecretStorage4Arguments(
            ...
            var __authorizations = global::AI21.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_V1SecretStorage4SecurityRequirements,
                operationName: "V1SecretStorage4Async");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::AI21.PathBuilder(
                                path: $"/studio/v1/secrets/{secretId}",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareV1SecretStorage4Request(
                    httpClient: HttpClient,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AI21.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AI21.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1SecretStorage4",
                                methodName: "V1SecretStorage4Async",
                                pathTemplate: "$\"/studio/v1/secrets/{secretId}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::AI21.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessV1SecretStorage4ResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> V1SecretStorage4Async(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::AI21.UpdateSecretPayload
            {
                SecretName = secretName,
                SecretValue = secretValue,
            };

            return await V1SecretStorage4Async(
                secretId: secretId,
                request: __request,
                requestOptions: requestOptions,
