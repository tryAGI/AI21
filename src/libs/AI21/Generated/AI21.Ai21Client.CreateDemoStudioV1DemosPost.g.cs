...
namespace AI21
{
    public partial class Ai21Client
    {
        ...
        private static readonly global::AI21.EndPointSecurityRequirement s_CreateDemoStudioV1DemosPostSecurityRequirement0 =
        ...
        private static readonly global::AI21.EndPointSecurityRequirement[] s_CreateDemoStudioV1DemosPostSecurityRequirements =
            new global::AI21.EndPointSecurityRequirement[]
            {                s_CreateDemoStudioV1DemosPostSecurityRequirement0,
            };
        partial void PrepareCreateDemoStudioV1DemosPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::AI21.DemoCreate request);
        partial void PrepareCreateDemoStudioV1DemosPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::AI21.DemoCreate request);
        partial void ProcessCreateDemoStudioV1DemosPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateDemoStudioV1DemosPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::AI21.Demo> CreateDemoStudioV1DemosPostAsync(

            global::AI21.DemoCreate request,
            global::AI21.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateDemoStudioV1DemosPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AI21.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AI21.AutoSDKHttpResponse<global::AI21.Demo>> CreateDemoStudioV1DemosPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateDemoStudioV1DemosPostArguments(
            ...
            var __authorizations = global::AI21.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateDemoStudioV1DemosPostSecurityRequirements,
                operationName: "CreateDemoStudioV1DemosPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateDemoStudioV1DemosPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AI21.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AI21.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateDemoStudioV1DemosPost",
                                methodName: "CreateDemoStudioV1DemosPostAsync",
                                pathTemplate: "\"/studio/v1/demos\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateDemoStudioV1DemosPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AI21.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateDemoStudioV1DemosPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::AI21.Demo.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::AI21.AutoSDKHttpResponse<global::AI21.Demo>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::AI21.Demo.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::AI21.Demo> CreateDemoStudioV1DemosPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::AI21.DemoCreate
            {
                Name = name,
            ...
            return await CreateDemoStudioV1DemosPostAsync(
                request: __request,
                requestOptions: requestOptions,
