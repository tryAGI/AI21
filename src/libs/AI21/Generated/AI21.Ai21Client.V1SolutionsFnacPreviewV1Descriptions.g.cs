...
namespace AI21
{
    public partial class Ai21Client
    {
        ...
        private static readonly global::AI21.EndPointSecurityRequirement s_V1SolutionsFnacPreviewV1DescriptionsSecurityRequirement0 =
        ...
        private static readonly global::AI21.EndPointSecurityRequirement[] s_V1SolutionsFnacPreviewV1DescriptionsSecurityRequirements =
            new global::AI21.EndPointSecurityRequirement[]
            {                s_V1SolutionsFnacPreviewV1DescriptionsSecurityRequirement0,
            };
        partial void PrepareV1SolutionsFnacPreviewV1DescriptionsArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareV1SolutionsFnacPreviewV1DescriptionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessV1SolutionsFnacPreviewV1DescriptionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessV1SolutionsFnacPreviewV1DescriptionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> V1SolutionsFnacPreviewV1DescriptionsAsync(
            global::AI21.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await V1SolutionsFnacPreviewV1DescriptionsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AI21.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AI21.AutoSDKHttpResponse<string>> V1SolutionsFnacPreviewV1DescriptionsAsResponseAsync(
            global::AI21.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareV1SolutionsFnacPreviewV1DescriptionsArguments(
                httpClient: HttpClient);


            var __authorizations = global::AI21.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_V1SolutionsFnacPreviewV1DescriptionsSecurityRequirements,
                operationName: "V1SolutionsFnacPreviewV1DescriptionsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareV1SolutionsFnacPreviewV1DescriptionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AI21.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AI21.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1SolutionsFnacPreviewV1Descriptions",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessV1SolutionsFnacPreviewV1DescriptionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AI21.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessV1SolutionsFnacPreviewV1DescriptionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
