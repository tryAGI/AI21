...
namespace AI21
{
    public partial class Ai21Client
    {
        ...
        private static readonly global::AI21.EndPointSecurityRequirement s_AnalyticsErrorsGatewayAnalyticsV1ErrorsGetSecurityRequirement0 =
        ...
        private static readonly global::AI21.EndPointSecurityRequirement[] s_AnalyticsErrorsGatewayAnalyticsV1ErrorsGetSecurityRequirements =
            new global::AI21.EndPointSecurityRequirement[]
            {                s_AnalyticsErrorsGatewayAnalyticsV1ErrorsGetSecurityRequirement0,
            };
        partial void PrepareAnalyticsErrorsGatewayAnalyticsV1ErrorsGetArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareAnalyticsErrorsGatewayAnalyticsV1ErrorsGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessAnalyticsErrorsGatewayAnalyticsV1ErrorsGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAnalyticsErrorsGatewayAnalyticsV1ErrorsGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> AnalyticsErrorsGatewayAnalyticsV1ErrorsGetAsync(
            global::AI21.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await AnalyticsErrorsGatewayAnalyticsV1ErrorsGetAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AI21.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AI21.AutoSDKHttpResponse<string>> AnalyticsErrorsGatewayAnalyticsV1ErrorsGetAsResponseAsync(
            global::AI21.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAnalyticsErrorsGatewayAnalyticsV1ErrorsGetArguments(
                httpClient: HttpClient);


            var __authorizations = global::AI21.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_AnalyticsErrorsGatewayAnalyticsV1ErrorsGetSecurityRequirements,
                operationName: "AnalyticsErrorsGatewayAnalyticsV1ErrorsGetAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::AI21.PathBuilder(
                                path: "/gateway/analytics/v1/errors",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAnalyticsErrorsGatewayAnalyticsV1ErrorsGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AI21.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AI21.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AnalyticsErrorsGatewayAnalyticsV1ErrorsGet",
                                methodName: "AnalyticsErrorsGatewayAnalyticsV1ErrorsGetAsync",
                                pathTemplate: "\"/gateway/analytics/v1/errors\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAnalyticsErrorsGatewayAnalyticsV1ErrorsGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AI21.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAnalyticsErrorsGatewayAnalyticsV1ErrorsGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
