...
namespace AI21
{
    public partial class Ai21Client
    {
        ...
        private static readonly global::AI21.EndPointSecurityRequirement s_GetFileUrlStudioV1DemosScraperFileUrlFileIdGetSecurityRequirement0 =
        ...
        private static readonly global::AI21.EndPointSecurityRequirement[] s_GetFileUrlStudioV1DemosScraperFileUrlFileIdGetSecurityRequirements =
            new global::AI21.EndPointSecurityRequirement[]
            {                s_GetFileUrlStudioV1DemosScraperFileUrlFileIdGetSecurityRequirement0,
            };
        ...
        partial void ProcessGetFileUrlStudioV1DemosScraperFileUrlFileIdGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await GetFileUrlStudioV1DemosScraperFileUrlFileIdGetAsResponseAsync(
                fileId: fileId,
                apiKey: apiKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AI21.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::AI21.AutoSDKHttpResponse<string>> GetFileUrlStudioV1DemosScraperFileUrlFileIdGetAsResponseAsync(
            string fileId,
            string? apiKey = default,
            global::AI21.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::AI21.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                operationName: "GetFileUrlStudioV1DemosScraperFileUrlFileIdGetAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::AI21.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::AI21.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetFileUrlStudioV1DemosScraperFileUrlFileIdGet",
                                methodName: "GetFileUrlStudioV1DemosScraperFileUrlFileIdGetAsync",
                                pathTemplate: "$\"/studio/v1/demos/scraper/file-url/{fileId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetFileUrlStudioV1DemosScraperFileUrlFileIdGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::AI21.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetFileUrlStudioV1DemosScraperFileUrlFileIdGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
