...
internal static partial class UpdateConfigTokenwiseSettingsConfigsConfigIdPutCommandApiCommand
{
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.UpdateConfigTokenwiseSettingsConfigsConfigIdPutAsync(
                                    configId: configId,
                                    overrides: overrides,
                                    name: name,
