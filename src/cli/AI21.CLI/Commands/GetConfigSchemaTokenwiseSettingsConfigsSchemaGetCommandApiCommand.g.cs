...
internal static partial class GetConfigSchemaTokenwiseSettingsConfigsSchemaGetCommandApiCommand
{
    ...
    {
        var command = new Command(@"get-config-schema-tokenwise-settings-configs-schema-get", @"Get Config Schema");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.GetConfigSchemaTokenwiseSettingsConfigsSchemaGetAsync(
