...
internal static partial class ProxyV1betaGatewayV1betaPathOptions6CommandApiCommand
{
    ...
    {
        var command = new Command(@"proxy-v1beta-gateway-v1beta-path-options6", @"Proxy V1Beta
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ProxyV1betaGatewayV1betaPathOptions6Async(
                                    path: path,
                                    xAi21Key: xAi21Key,
