...
internal static partial class GetStepExplanationsStudioV1ExecutionsExecutionIdExplanationsStepsGetCommandApiCommand
{
    ...
    {
        var command = new Command(@"get-step-explanations-studio-v1-executions-execution-id-explanations-steps-get", @"Get Step Explanations
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.GetStepExplanationsStudioV1ExecutionsExecutionIdExplanationsStepsGetAsync(
