...
internal static partial class ProxyV1betaTokenwiseV1betaPathOptions2CommandApiCommand
{
    ...
    {
        var command = new Command(@"proxy-v1beta-tokenwise-v1beta-path-options2", @"Proxy V1Beta
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ProxyV1betaTokenwiseV1betaPathOptions2Async(
                                    path: path,
                                    xAi21Key: xAi21Key,
