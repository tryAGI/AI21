...
internal static partial class DismissInsightTokenwiseInsightsInsightIdDismissPostCommandApiCommand
{
    ...
    {
        var command = new Command(@"dismiss-insight-tokenwise-insights-insight-id-dismiss-post", @"Dismiss Insight
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.DismissInsightTokenwiseInsightsInsightIdDismissPostAsync(
                                    insightId: insightId,
