...
internal static partial class ProxyV1betaGatewayV1betaPathDelete6CommandApiCommand
{
    ...
    {
        var command = new Command(@"proxy-v1beta-gateway-v1beta-path-delete6", @"Proxy V1Beta
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ProxyV1betaGatewayV1betaPathDelete6Async(
                                    path: path,
                                    xAi21Key: xAi21Key,
