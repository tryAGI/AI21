...
internal static partial class SubmitInsightFeedbackTokenwiseInsightsInsightIdFeedbackPostCommandApiCommand
{
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.SubmitInsightFeedbackTokenwiseInsightsInsightIdFeedbackPostAsync(
                                    insightId: insightId,
                                    verdict: verdict,
                                    comment: comment,
