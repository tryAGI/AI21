...
internal static partial class ProxyV1internalTokenwiseV1internalPathPut5CommandApiCommand
{
    ...
    {
        var command = new Command(@"proxy-v1internal-tokenwise-v1internal-path-put5", @"Proxy V1Internal
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ProxyV1internalTokenwiseV1internalPathPut5Async(
                                    path: path,
                                    xAi21Key: xAi21Key,
