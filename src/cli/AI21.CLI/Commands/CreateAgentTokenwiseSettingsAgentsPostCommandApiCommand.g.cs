...
internal static partial class CreateAgentTokenwiseSettingsAgentsPostCommandApiCommand
{
    ...
    {
        var command = new Command(@"create-agent-tokenwise-settings-agents-post", @"Create Agent");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.CreateAgentTokenwiseSettingsAgentsPostAsync(
                                    agentId: agentId,
                                    kind: kind,
                                    name: name,
