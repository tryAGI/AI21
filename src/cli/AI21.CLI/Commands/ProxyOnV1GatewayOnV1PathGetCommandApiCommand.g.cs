...
internal static partial class ProxyOnV1GatewayOnV1PathGetCommandApiCommand
{
    ...
    {
        var command = new Command(@"proxy-on-v1-gateway-on-v1-path-get", @"Proxy On V1
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ProxyOnV1GatewayOnV1PathGetAsync(
                                    path: path,
                                    xAi21Key: xAi21Key,
