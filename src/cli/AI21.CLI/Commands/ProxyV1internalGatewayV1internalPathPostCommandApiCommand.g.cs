...
internal static partial class ProxyV1internalGatewayV1internalPathPostCommandApiCommand
{
    ...
    {
        var command = new Command(@"proxy-v1internal-gateway-v1internal-path-post", @"Proxy V1Internal
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ProxyV1internalGatewayV1internalPathPostAsync(
                                    path: path,
                                    xAi21Key: xAi21Key,
