...
internal static partial class ProxyV1GatewayV1PathPatch4CommandApiCommand
{
    ...
    {
        var command = new Command(@"proxy-v1-gateway-v1-path-patch4", @"Proxy V1
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ProxyV1GatewayV1PathPatch4Async(
                                    path: path,
                                    xAi21Key: xAi21Key,
