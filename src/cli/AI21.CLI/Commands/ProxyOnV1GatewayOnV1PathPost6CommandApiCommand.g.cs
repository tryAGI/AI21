...
internal static partial class ProxyOnV1GatewayOnV1PathPost6CommandApiCommand
{
    ...
    {
        var command = new Command(@"proxy-on-v1-gateway-on-v1-path-post6", @"Proxy On V1
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ProxyOnV1GatewayOnV1PathPost6Async(
                                    path: path,
                                    xAi21Key: xAi21Key,
