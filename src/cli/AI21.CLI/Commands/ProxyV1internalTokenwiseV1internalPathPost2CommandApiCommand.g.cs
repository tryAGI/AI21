...
internal static partial class ProxyV1internalTokenwiseV1internalPathPost2CommandApiCommand
{
    ...
    {
        var command = new Command(@"proxy-v1internal-tokenwise-v1internal-path-post2", @"Proxy V1Internal
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ProxyV1internalTokenwiseV1internalPathPost2Async(
                                    path: path,
                                    xAi21Key: xAi21Key,
