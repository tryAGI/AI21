...
internal static partial class UpdateAgentTokenwiseSettingsAgentsAgentIdPutCommandApiCommand
{
    ...
    {
        var command = new Command(@"update-agent-tokenwise-settings-agents-agent-id-put", @"Update Agent");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.UpdateAgentTokenwiseSettingsAgentsAgentIdPutAsync(
                                    agentId: agentId,
                                    name: name,
                                    kind: kind,
