...
internal static partial class ProxyV1internalGatewayV1internalPathPatch3CommandApiCommand
{
    ...
    {
        var command = new Command(@"proxy-v1internal-gateway-v1internal-path-patch3", @"Proxy V1Internal
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ProxyV1internalGatewayV1internalPathPatch3Async(
                                    path: path,
                                    xAi21Key: xAi21Key,
