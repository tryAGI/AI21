...
internal static partial class ProxyV1TokenwiseV1PathPut6CommandApiCommand
{
    ...
    {
        var command = new Command(@"proxy-v1-tokenwise-v1-path-put6", @"Proxy V1
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ProxyV1TokenwiseV1PathPut6Async(
                                    path: path,
                                    xAi21Key: xAi21Key,
