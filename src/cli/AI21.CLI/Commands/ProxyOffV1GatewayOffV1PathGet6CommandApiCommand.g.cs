...
internal static partial class ProxyOffV1GatewayOffV1PathGet6CommandApiCommand
{
    ...
    {
        var command = new Command(@"proxy-off-v1-gateway-off-v1-path-get6", @"Proxy Off V1
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ProxyOffV1GatewayOffV1PathGet6Async(
                                    path: path,
                                    xAi21Key: xAi21Key,
