...
internal static partial class ProxyV1GatewayV1PathPost3CommandApiCommand
{
    ...
    {
        var command = new Command(@"proxy-v1-gateway-v1-path-post3", @"Proxy V1
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ProxyV1GatewayV1PathPost3Async(
                                    path: path,
                                    xAi21Key: xAi21Key,
