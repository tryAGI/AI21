...
internal static partial class ProxyV1betaTokenwiseV1betaPathPatchCommandApiCommand
{
    ...
    {
        var command = new Command(@"proxy-v1beta-tokenwise-v1beta-path-patch", @"Proxy V1Beta
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ProxyV1betaTokenwiseV1betaPathPatchAsync(
                                    path: path,
                                    xAi21Key: xAi21Key,
