...
internal static partial class ListAllInsightsGatewayInsightsAllGetCommandApiCommand
{
    ...
    {
        var command = new Command(@"list-all-insights-gateway-insights-all-get", @"List All Insights
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ListAllInsightsGatewayInsightsAllGetAsync(
