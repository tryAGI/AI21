...
internal static partial class ProxyOffV1TokenwiseOffV1PathPatch4CommandApiCommand
{
    ...
    {
        var command = new Command(@"proxy-off-v1-tokenwise-off-v1-path-patch4", @"Proxy Off V1
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ProxyOffV1TokenwiseOffV1PathPatch4Async(
                                    path: path,
                                    xAi21Key: xAi21Key,
