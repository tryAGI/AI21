...
internal static partial class ProxyOnV1TokenwiseOnV1PathPut3CommandApiCommand
{
    ...
    {
        var command = new Command(@"proxy-on-v1-tokenwise-on-v1-path-put3", @"Proxy On V1
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ProxyOnV1TokenwiseOnV1PathPut3Async(
                                    path: path,
                                    xAi21Key: xAi21Key,
