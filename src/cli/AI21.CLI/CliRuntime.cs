...
{
    private const string UserSecretsId = "AI21.CLI";
    private const string UserSecretApiKeyName = "AI21_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"AI21_API_KEY"];
    private const string CredentialFileDirectoryName = ".ai21";

    public static async global::System.Threading.Tasks.Task<global::AI21.Ai21Client> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::AI21.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::AI21.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::AI21.Ai21Client(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::AI21.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::AI21.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::AI21.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::AI21.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("AI21_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::AI21.ApiException exception)
    {
        var builder = new StringBuilder();
